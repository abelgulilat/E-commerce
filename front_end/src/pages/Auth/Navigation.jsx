...
return (
    <div style={{ zIndex: 9999 }} className={`flex  lg:flex xl:flex flex-col justify-between p-4 text-white bg-[#000]  w-[4%] hover:w-[20%] h-[100vh]  fixed ${showSidebar ? "hidden" : "flex"}  `} id="navigation-container">
